...
const defaultCategories: Category[] = [
  {
    ...
    prompts: [
      ...
      { id: "n2", text: "秋天的森林，金黄色的落叶，阳光透过树叶洒下斑驳光影" },
      { id: "n3", text: "热带海滩，碧蓝的海水，白色的沙滩，椰子树，夕阳西下" },
      { id: "n4", text: "云雾缭绕的山峰，水墨画风格，宁静致远" },
      { id: "n5", text: "瀑布飞流直下，彩虹横跨，周围绿树成荫" }
    ]
  },
  {
    id: "cyberpunk",
    ...
    icon: "🌃",
    prompts: [
      { id: "c1", text: "未来的东京街道，霓虹灯闪烁，雨夜，飞行汽车，赛博朋克风格" },
      { id: "c2", text: "高科技实验室，全息投影，蓝色冷光，机械臂" },
      { id: "c3", text: "赛博朋克少女，机械义肢，发光的纹身，背景是繁华的未来城市" },
      { id: "c4", text: "废弃的工业区，巨大的生锈齿轮，被植物覆盖，末日废土风" },
      { id: "c5", text: "黑客的房间，多屏显示器，绿色的代码流动，暗黑风格" }
    ]
  },
  {
    id: "anime",
    ...
    icon: "🌸",
    prompts: [
      { id: "a1", text: "吉卜力风格，夏天，骑自行车的少女，蓝天白云，绿草地" },
      { id: "a2", text: "新海诚风格，繁星点点的夜空，流星划过，城市夜景" },
      { id: "a3", text: "魔法少女，华丽的服饰，发光的魔法阵，梦幻背景" },
      { id: "a4", text: "古风少年，白衣飘飘，吹笛子，桃花林" },
      { id: "a5", text: "可爱的猫咪，拟人化，穿着侦探服，手拿放大镜" }
    ]
  },
  {
    id: "abstract",
    ...
    icon: "🎨",
    prompts: [
      { id: "ab1", text: "流动的色彩，油画质感，梵高风格，星空与麦田的结合" },
      { id: "ab2", text: "几何图形的碰撞，极简主义，黑白灰配色，现代感" },
      { id: "ab3", text: "梦境般的场景，扭曲的时钟，漂浮的岛屿，超现实主义" },
      { id: "ab4", text: "水彩晕染，淡雅的色彩，花卉图案，柔和" },
      { id: "ab5", text: "分形艺术，复杂的图案，无限循环，迷幻色彩" }
    ]
  }
];
